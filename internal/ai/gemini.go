...
func (r *Rotator) GenerateText(prompt string) (string, error) {
        ...
        return r.tryProxyThenDirect("", contents, "", false)
}
...
func (r *Rotator) ImproveRequest(subject, body string) (string, string, error) {
        ...
        text, err := r.tryProxyThenDirect(systemPrompt, contents, "application/json", false)
        if err != nil {
...
func (r *Rotator) AnalyzeReply(subject, body string) (string, error) {
        ...
        return r.tryProxyThenDirect(systemPrompt, contents, "", false)
}
...
- Якщо мова голосового не українська — body перекладай на українську.`
        ...
        text, err := r.tryProxyThenDirect(systemPrompt, contents, "application/json", true)
        if err != nil {
                return "", "", "", "", err
        }
...
func (r *Rotator) RefineRequest(draftJSON string, instructions string, audioData []byte) (string, error) {
        ...
        return r.tryProxyThenDirect(systemPrompt, contents, "application/json", true)
}
...
func (r *Rotator) GenerateSocialPost(text, tone string, photoBase64 []byte) (string, error) {
        ...
        return r.tryProxyThenDirect(systemPrompt, contents, "", true)
}
...
func (r *Rotator) ValidateSubmission(text string, photoBase64 []byte) (bool, string, error) {
        ...
        result, err := r.tryProxyThenDirect("Перевіряй на наявність ПІБ, адрес, телефонів та інших персональних даних. Поверни JSON: {\"isSafe\": bool, \"reason\": string}", contents, "application/json", false)
        if err != nil {
